        ...
        <Document>
            {Array.from({ length: totalPages }).map((_, pageIndex) => (
                <Page key={pageIndex} size="A4" style={styles.page}>
                    ...
                    {reconditionings.slice(pageIndex * 10, (pageIndex + 1) * 10).map((appointment, index) => (
...
// eslint-disable-next-line react/prop-types
const reconditioningsListPDF = ({ reconditionings }) => {
    ...
    return (
        <div>
            <PDFDownloadLink
                document={<ReconditioningPDF reconditionings={reconditionings} />}
...
export default reconditioningsListPDF;